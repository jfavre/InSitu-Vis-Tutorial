...
$\mapsto$ Very high data transfer<br>
$\mapsto$ Visualization machine needs to be almost as powerful as the supercomputer<br>

$\mapsto$ The alternative: use smaller temporal and spatial subsets<br>
 </div>
