...
## Instrument SPH-EXA with Ascent
<br>
...
uenv start ascent/0.9.5:v1 --view=default

ls -C1 relay_output.cycle_00* > cycles_list.txt
mkdir datasets
export PATH=/user-tools/linux-neoverse_v2/ascent-0.9.5-culrqd3zwazfbh4oc4ytlilzy5fisp4d/utilities/ascent/replay/:$PATH
ascent_replay --cycles=cycles_list.txt --actions=../sphexa_Ascent_threshold_sedov.yaml
...
## Instrument a mini Heat Diffusion example with Ascent. Act I

- Visit our [Heat Diffusion] example
...
srun -u -n 4 --reservation=insitu -t 2 ./buildAscent/bin/heat_diffusion --mesh=uniform --res=64
```
