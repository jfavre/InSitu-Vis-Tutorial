...
- overide it at run-time with a file called [ascent_actions.yaml](https://ascent.readthedocs.io/en/latest/AscentAPI.html#open)<br>
...
mkdir datasets
<path>/utilities/ascent/replay/ascent_replay --cycles=cycles_list.txt --actions=sphexa_Ascent_twoclips_sedov.yaml
ls -l datasets/density.0
```
---
level: 2
---
## A advanced example with query/expressions
