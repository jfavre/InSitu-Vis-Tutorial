...
- They are only the ones I have had time to try, and used to instrument some
  applications. Quite a bit ParaView, or VTK-m centric

- Look at [SENSEI] (a generic data interface and a data model) to serve data to
Libsim, Catalyst2, or ADIOS...

- look at the [WOIV] workshops at ISC,

[SENSEI]: https://sensei-insitu.org/learn-more/software.html
[WOIV]: https://woiv.gitlab.io/woiv25/
...
- In-situ Analysis and Visualization with Ascent and ParaView Catalyst, SC23,
...
[tutorial]: https://github.com/jfavre/InSitu-Vis-Tutorial2022/tree/main/Examples
