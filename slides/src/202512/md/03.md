...
# Ascent: an in situ visualization and analysis library<br>based on _Conduit_
...
- References:
    ...
    - [The ALPINE in situ infrastructure: Ascending from the ashes of strawman], M. Larsen et al, 2017
...
# Ascent: scene description (JSON or YAML format)
...
# Ascent: add a pipeline description
...
# Ascent: the new pipeline refines the scene description
