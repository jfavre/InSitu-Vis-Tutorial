...
Deploying an Ascent-based in-situ coupling requires:

- A data description using Conduit nodes
- Actions (scenes, pipelines, extracts,..) definitions for run-time visualization and analysis

Warning<br>
- There is no user-friendly GUI. The doc is your best friend. [See examples](https://ascent.readthedocs.io/en/latest/Actions/index.html)
