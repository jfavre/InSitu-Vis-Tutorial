...
<br>
  <div class="w-220">
        <img src="/img/01_posthoc_io.png" class="ml-1 border=1px"/>
  </div>
...
# In situ visualization
  ...
  <div class="w-220">
        <img src="/img/01_posthoc_inline.png" class="ml-1 border=1px"/>
  </div>
...
<br>
 ...
 Figure taken from 'In Situ Visualization for Computational Science', Hank Childs et al., IEEE CG&A, dec 2019
...
<br>
  ...
  <div class="w-170">
        <img src="/img/01_axes.png" class="ml-20 border=2px"/>
  </div>
