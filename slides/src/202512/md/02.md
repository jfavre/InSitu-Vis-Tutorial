...
- The Node class provides two ways to hold data.<br>
...
- [blueprint_example1.cpp](https://github.com/Alpine-DAV/ascent/blob/develop/src/examples/tutorial/ascent_intro/cpp/blueprint_example1.cpp#L1-L74)
- [blueprint_example1.py](https://github.com/Alpine-DAV/ascent/blob/develop/src/examples/tutorial/ascent_intro/python/blueprint_example1.py#L1-L65)
<br>
<br>
<br>
<br>
<v-click>Bonus. Conduit comes with its own I/O layer !!!</v-click>
<v-click><br>Save your data as Blueprint HDF5</v-click><br>
<v-click>&nbsp;&nbsp;&nbsp;&nbsp; conduit.relay.io.blueprint.write_mesh(mesh, "/tmp/foobar", "hdf5")</v-click><br>
<v-click><br>Read it back with:</v-click><br>
<v-click>&nbsp;&nbsp;&nbsp;&nbsp; - VisIt or,</v-click><br>
<v-click>&nbsp;&nbsp;&nbsp;&nbsp; - ParaView (with JF's blueprint reader plugin)</v-click>
---
level: 2
---
